...
var file_proto_squidgame_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x08, 0x52, 0x04, 0x64, 0x65, 0x61, 0x64, 0x32, 0x99, 0x02, 0x0a, 0x10, 0x53, 0x71,
	...
	0x12, 0x33, 0x0a, 0x0b, 0x44, 0x65, 0x61, 0x64, 0x4f, 0x72, 0x41, 0x6c, 0x69, 0x76, 0x65, 0x12,
	0x11, 0x2e, 0x67, 0x72, 0x70, 0x63, 0x2e, 0x44, 0x65, 0x61, 0x64, 0x52, 0x65, 0x71, 0x75, 0x65,
	0x73, 0x74, 0x1a, 0x0f, 0x2e, 0x67, 0x72, 0x70, 0x63, 0x2e, 0x44, 0x65, 0x61, 0x64, 0x52, 0x65,
	0x70, 0x6c, 0x79, 0x22, 0x00, 0x42, 0x27, 0x5a, 0x25, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e,
	0x63, 0x6f, 0x6d, 0x2f, 0x66, 0x61, 0x62, 0x69, 0x75, 0x73, 0x69, 0x6e, 0x66, 0x6f, 0x2f, 0x53,
	0x71, 0x75, 0x69, 0x64, 0x47, 0x61, 0x6d, 0x65, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x06,
...
var file_proto_squidgame_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
...
var file_proto_squidgame_proto_depIdxs = []int32{
	...
	1, // 5: grpc.SquidGameService.SayHello:output_type -> grpc.HelloReply
	3, // 6: grpc.SquidGameService.JoinGame:output_type -> grpc.JoinReply
	5, // 7: grpc.SquidGameService.SendPlays:output_type -> grpc.SendReply
	7, // 8: grpc.SquidGameService.AmountCheck:output_type -> grpc.AmountReply
	9, // 9: grpc.SquidGameService.DeadOrAlive:output_type -> grpc.DeadReply
