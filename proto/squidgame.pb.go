...
func (x *AllplaysRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AllplaysRequest) ProtoMessage() {}

func (x *AllplaysRequest) ProtoReflect() protoreflect.Message {
	mi := &file_proto_squidgame_proto_msgTypes[10]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AllplaysRequest.ProtoReflect.Descriptor instead.
func (*AllplaysRequest) Descriptor() ([]byte, []int) {
	return file_proto_squidgame_proto_rawDescGZIP(), []int{10}
}

func (x *AllplaysRequest) GetPlayer() string {
	if x != nil {
		return x.Player
	}
	return ""
...
type AllplaysReply struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Plays string `protobuf:"bytes,1,opt,name=plays,proto3" json:"plays,omitempty"`
}

func (x *AllplaysReply) Reset() {
	*x = AllplaysReply{}
	if protoimpl.UnsafeEnabled {
...
func (x *AllplaysReply) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AllplaysReply) ProtoMessage() {}

func (x *AllplaysReply) ProtoReflect() protoreflect.Message {
	mi := &file_proto_squidgame_proto_msgTypes[11]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AllplaysReply.ProtoReflect.Descriptor instead.
func (*AllplaysReply) Descriptor() ([]byte, []int) {
	return file_proto_squidgame_proto_rawDescGZIP(), []int{11}
}

func (x *AllplaysReply) GetPlays() string {
	if x != nil {
		return x.Plays
	}
	return ""
...
var file_proto_squidgame_proto_rawDesc = []byte{
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x6d, 0x6f, 0x6e, 0x74, 0x6f, 0x22, 0x25, 0x0a, 0x0b, 0x44,
	...
	,
	...
	0x00, 0x12, 0x3a, 0x0a, 0x0a, 0x41, 0x6c, 0x6c, 0x50, 0x6c, 0x61, 0x79, 0x73, 0x4f, 0x66, 0x12,
	0x15, 0x2e, 0x67, 0x72, 0x70, 0x63, 0x2e, 0x41, 0x6c, 0x6c, 0x70, 0x6c, 0x61, 0x79, 0x73, 0x52,
	0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x13, 0x2e, 0x67, 0x72, 0x70, 0x63, 0x2e, 0x41, 0x6c,
	0x6c, 0x70, 0x6c, 0x61, 0x79, 0x73, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x22, 0x00, 0x42, 0x27, 0x5a,
	0x25, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x66, 0x61, 0x62, 0x69,
	0x75, 0x73, 0x69, 0x6e, 0x66, 0x6f, 0x2f, 0x53, 0x71, 0x75, 0x69, 0x64, 0x47, 0x61, 0x6d, 0x65,
...
var file_proto_squidgame_proto_goTypes = []interface{}{
	...
	(*AllplaysRequest)(nil), // 10: grpc.AllplaysRequest
	(*AllplaysReply)(nil),   // 11: grpc.AllplaysReply
}
var file_proto_squidgame_proto_depIdxs = []int32{
	...
	10, // 5: grpc.SquidGameService.AllPlaysOf:input_type -> grpc.AllplaysRequest
	...
	11, // 11: grpc.SquidGameService.AllPlaysOf:output_type -> grpc.AllplaysReply
